...
public class ProductsApiService
{
    ...
    //public async async <Task<GenericApiResponse<string>>> UpdateProductDetailsAsync(ProductRequest UpdateproductDetailsRequest)
    //{
    //    var response = await _httpClient.GetFromJsonAsync<GenericApiResponse<string>>("")
    //}
}
