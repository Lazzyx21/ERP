...
builder.Services.AddSingleton(new HttpClient { BaseAddress = new Uri("http://localhost:5163/api/controller/bomlistreponse", "http://localhost:5163/api/controller/OrderProcessingList") });
